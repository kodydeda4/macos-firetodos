...
final class SignInWithAppleToFirebase: NSViewControllerRepresentable {
    ...
    func makeNSViewController(context: Context) -> NSViewController {
        let vc = NSHostingController(rootView: SignInWithApple().onTapGesture(perform: showAppleLogin))
        return vc as NSViewController
    }
  
    func updateNSViewController(_ NSView: NSViewController, context: Context) {
...
class SignInWithAppleDelegates: NSObject {
    ...
    init(window: NSWindow?, currentNonce: String, onLoginEvent: ((SignInWithAppleToFirebaseResponse) -> ())? = nil) {
        self.window = window
